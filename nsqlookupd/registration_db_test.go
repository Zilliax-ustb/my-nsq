...
func TestRegistrationDB(t *testing.T) {
	...
	pi1 := &PeerInfo{beginningOfTime.UnixNano(), "1", "remote_addr:1", "host", "b_addr", 1, 2, "v1", 0, "127.0.0.1:4150", 123, nil}
	pi2 := &PeerInfo{beginningOfTime.UnixNano(), "2", "remote_addr:2", "host", "b_addr", 2, 3, "v1", 0, "127.0.0.1:4250", 123, nil}
	pi3 := &PeerInfo{beginningOfTime.UnixNano(), "3", "remote_addr:3", "host", "b_addr", 3, 4, "v1", 0, "127.0.0.1:4350", 123, nil}
